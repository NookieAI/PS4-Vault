...
PS4 Vault is a free Windows app that lets you browse, organise and install PS4/PS5 game files (PKGs) on your computer and console — all from one clean interface.
...
1. Download `PS4.Vault-1.0.0-setup.exe` from the [Releases page](https://github.com/YOUR_GITHUB_USERNAME/ps4-vault/releases/latest) and run it
...
## Scanning games installed on your console

1. Click the **🎮 PS4/PS5** button in the toolbar
2. Enter your console's IP address (or click Find Console)
3. Click **Installed Games**

PS4 Vault will read the game list directly from your console and show covers, file sizes and version numbers — exactly like your local library.
...
Check the log file — it records everything that happens:

**Menu → 📋 View Log File**

Or find it here: `C:\Users\YourName\AppData\Roaming\PS4Vault\ps4vault.log`

If you need help, share the log file on Discord and someone can take a look.
